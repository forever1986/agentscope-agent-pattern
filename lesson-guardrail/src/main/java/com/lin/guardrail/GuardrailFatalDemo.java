...
public class GuardrailFatalDemo {
    ...
    public static void main(String[] args) {
        ...
        FourthInputGuardrail fourthInputGuardrail = new FourthInputGuardrail("fourthInputGuardrail");
        ...
        ReActAgent agent =
                ReActAgent.builder()
                        ...
                        .model(DashScopeChatModel.builder()
                                ...
                                .build())
                        .hooks(List.of(firstInputGuardrail, secondInputGuardrail, thirdInputGuardrail , fourthInputGuardrail, fifthInputGuardrail))
                        .build();
